...
const { nomLoFav, nomKategori } = Nominasi;
      ...
      <div className={styles.main}>
        <div className={styles.choiceWrapper}>
          <div className={styles.choiceHeading}>
            <h2>{nomKategori[4].nominasi_title}</h2>
            <p>{nomKategori[4].deskripsi}</p>
          </div>
          <div className={styles.info}>
            <div className={styles.infoWrapper}>
              {nomLoFav.map((x, index) => {
                return (
                  <LembagaDisplay
                    key={index}
                    index={index}
